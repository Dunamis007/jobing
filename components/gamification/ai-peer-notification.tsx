...
import { Bell, Star, Trophy, ArrowUp, X, Brain } from "lucide-react"
import { cn } from "@/lib/utils"

interface PeerNotification {
  id: string
  type: "upgrade" | "achievement" | "streak" | "unlock"
  user: {
    name: string
    avatar: string
  }
...
export function AIPeerNotification() {
  ...
  const sampleNotifications: PeerNotification[] = [
    ...
    },
    {
      ...
      message: "earned the 'AI Explorer' badge!",
      timestamp: new Date(),
    },
    {
      id: "3",
      ...
      message: "is on a 30-day AI learning streak!",
      timestamp: new Date(),
    },
    {
      id: "4",
      ...
      message: "unlocked the Advanced NLP module!",
      timestamp: new Date(),
    },
  ]
