...
export function DigitalMarketingHallOfFame() {
  ...
  const hallOfFame: HallOfFameEntry[] = [
    {
      ...
      winner: {
        ...
        project: "Social Media Campaign for Fashion Brand",
        score: 98,
      },
    },
    {
      ...
      winner: {
        name: "Tunde Bakare",
        avatar: "/placeholder.svg?height=60&width=60",
        project: "SEO Strategy for E-commerce Website",
        score: 95,
      },
    },
    {
  ...
  const monthlyWinners = [
    {
      ...
      winner: {
        name: "David Okonkwo",
        avatar: "/placeholder.svg?height=60&width=60",
        project: "Comprehensive Digital Marketing Strategy",
        score: 99,
      },
    },
    {
  ...
  const allTimeWinners = [
    {
      ...
      winner: {
        ...
        score: 98,
        badges: ["Social Media Expert", "Content Creator"],
      },
    },
    {
      season: "Winter 2023",
      winner: {
        ...
        score: 99,
        badges: ["Brand Strategist", "Analytics Expert"],
      },
    },
  ]
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-1">
            ...
            <Button
              ...
              className={timeframe === "allTime" ? "bg-green-600 hover:bg-green-700" : ""}
            >
              All Time
            </Button>
          </div>
        </div>
        <CardDescription>Celebrating our top marketing campaign creators</CardDescription>
      </CardHeader>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1 mt-1">
                      <Badge className="bg-green-600 text-white text-xs">Score: {entry.winner.score}/100</Badge>
                    </div>
                  </div>
                </div>
              </div>
