...
import { CheckCircle, Briefcase, CoinsIcon, AlertCircle, Brain, Code, Zap, Users, BookOpen } from "lucide-react"
...
export function AICareerGame() {
  ...
  return (
    <>
      ...
      {showNotification && (
        <div className="fixed bottom-4 right-4 bg-white p-4 rounded-lg shadow-lg border-l-4 border-blue-500 max-w-sm z-50">
