...
export function CybersecurityRegistrationClient() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      router.push("/register/payment?program=cybersecurity")
    } catch (error) {
      toast({
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <CardTitle className="text-2xl">Cybersecurity Program Registration</CardTitle>
              <CardDescription>Enroll in our comprehensive cybersecurity training program</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent>
                  ...
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="intermediate">Intermediate - Some IT knowledge</SelectItem>
                        <SelectItem value="advanced">Advanced - IT professional seeking specialization</SelectItem>
                      </SelectContent>
                    </Select>
                    <FormMessage />
                  </FormItem>
